...
\title{NATURAL VARIABILITY IN THE EARTH'S
CLIMATE SYSTEM}    %your thesis title,
...
\degreedate{December 2017}         %the degree date
...
\include{chapter-SHcirc}
\include{chapter-ocean-heat-carbon}
\include{chapter-oxygen}
...
\bibliography{/RESEARCH/library}        %use a bibtex bibliography file refs.bib
